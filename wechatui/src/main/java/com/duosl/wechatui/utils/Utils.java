...
public class Utils {
    ...
    /**
     * @param activity
     * @param useThemestatusBarColor   是否使用默认主题色状态栏，不设置则为透明色
     * @param isDarkTheme 是否不需要使用状态栏为暗色调
     */
    public static void setStatusBar(Activity activity, boolean useThemestatusBarColor, boolean isDarkTheme) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {//5.0及以上
            ...
            if (useThemestatusBarColor) {
                activity.getWindow().setStatusBarColor(activity.getResources().getColor(R.color.colorDefault));
//                int toolBarBackgroundColor = ((Toolbar)activity.findViewById(R.id.common_app_bar)).getBackground();
//                L.d(toolBarBackgroundColor+"");
//                activity.getWindow().setStatusBarColor(toolBarBackgroundColor);
            } else {
